...
class CityTest(unittest.TestCase):
    ...
    def test_class_attribute(self):
        ...
        user1 = City(name="New York", state_id="12345")
        self.assertEqual(user1.name, "New York")
        self.assertEqual(user1.state_id, "12345")
    ...
    def test_doc(self):
        """Check documentation """
        self.assertIsNotNone(models.city.__doc__)  # type: ignore
